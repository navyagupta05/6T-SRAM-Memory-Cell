...
## Overview
The physical layout of the **6T SRAM cell** was implemented using **Microwind (180 nm CMOS technology)**.  
The design follows a **symmetrical structure** to ensure proper matching between transistors and balanced operation.
...
## Power Consumption
- **Post-layout power consumption:** ≈ **44.723 µW**  
